...
(function () {
    ...
    * @returns {{}}
    */
   function getPackagesPath(grunt, data, application) {
      ...
      Object.keys(languages).forEach(function(lang) {
         ...
         css = bumpImportsUp(languages[lang].css.map(function(css){
            return resolveUrl(data.packages, grunt.file.read(css), path.dirname(css));
         }).join('\n'));
   ...
   module.exports = {
      ...
      packageDictionary: function(grunt, data, application) {
         ...
         var paths = getPackagesPath(grunt, data, application);
         try {
