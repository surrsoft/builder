...
(function () {
   ...
   var helpers = module.exports = {
      ...
      /**
       * Переводит на все языки и разбивает на статики
       * @param grunt
       * @param application
       */
      translateAll: function(grunt, application){
         Object.keys(helpers.dictionary).forEach(function(lang){
            helpers.createLangStatic(grunt, lang, application);
         });
      },

      /**
       * Переводит на конкретный язык
       * @param grunt
       * @param lang
       * @param application
       */
      translateOne: function(grunt, lang, application) {
       ...
       * @param application
       */
      translateDef: function(grunt, application) {
         helpers.recursive(grunt, application, function(abspath, rootdir, subdir, filename) {
            if (/\.xhtml$/.test(filename)) {
               helpers.copy(grunt, abspath, abspath, null, true);
            }
         });

         // На статике по умолчанию нет поддердживаемых языков
         helpers.replaceContents(grunt, 'availableLanguage', {}, application);
         helpers.replaceContents(grunt, 'dictionary', {}, application);
      },
       ...
       * @param application
       */
      indexDict: function(grunt, application) {
         var availableLang = {},
             jsDict = {};
         helpers.recursive(grunt, application, function(abspath) {
            var lang = abspath.match(/\/resources\/lang\/(.+)\.json$/);
         ...
         Object.keys(helpers.dictionary).forEach(function(lang){
            availableLang[lang] = ISO639[lang];
         });
         helpers.replaceContents(grunt, 'availableLanguage', availableLang, application);
         helpers.replaceContents(grunt, 'dictionary', jsDict, application);
      },
      ...
      findDictionary: function(grunt, dictMask) {
         ...
         sourceFiles.forEach(function(pathToSource) {
            ...
            try {
               ...
               grunt.fail.warn('Can\'t read ' + pathToSource);
            }
         });
      },
      ...
      replaceContents: function(grunt, key, value, subdir) {
         ...
         try {
            ...
            grunt.fail.warn('Can\'t read content.json file');
         }
      },
      ...
      getDictionaryPath: function(grunt, obj, lang, path) {
         ...
         var langDir = 'resources/lang/' + lang + '.json',
            ...
            try {
               ...
               if (text) {
                  ...
                  if (modName) {
                     ...
                     cssPath = path.replace(langDir, 'resources/lang/' + lang + '.css');
       ...
       * @param callback
       */
      recursive: function(grunt, application, callback) {
       ...
       */
      createLangStatic: function(grunt, lang, application) {
         if (!lang) return;
         ...
         helpers.recursive(grunt, application, function(abspath, rootdir, subdir, filename) {
            ...
            var isDict;
            isDict = (isDict = abspath.match(/\/resources\/lang\/(.+)\.json$/)) ? isDict[1] : null;
         ...
         availableLang[lang] = ISO639[lang];
         helpers.replaceContents(grunt, 'availableLanguage', availableLang, langDir);
         helpers.replaceContents(grunt, 'dictionary', jsDict, langDir);
      }
   }
})();