...
class TemplatesBuilder {
   ...
   requireView() {
      this.AppEnv = global.requirejs('Application/Env').App;
      /* eslint-disable no-console */
      console.error('this.AppEnv', this.AppEnv, '::', typeof this.AppEnv);
   ...
   async render(_options) {
      const html = await new Promise((resolve, reject) => {
         global.requirejs(['UI/Base'], (UIBase) => {
            const config = {
            ...
            try {
               this.AppEnv.startRequest(config, new UIBase.StateReceiver());
