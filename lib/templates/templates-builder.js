...
class TemplatesBuilder {
   ...
   async render(_options) {
      const html = await new Promise((resolve, reject) => {
         global.requirejs(['Application/Env', 'UI/Base'], (AppEnv, UIBase) => {
            const config = {
            ...
            const Application = AppEnv.App;
            try {
               /* eslint-disable no-new */
               new Application(config, undefined, new UIBase.StateReceiver());
               /* eslint-enable no-new */
               resolve(route(config));
            } catch (e) {
               /* eslint-disable no-console */
               console.error('AppEnv ', AppEnv, typeof AppEnv, JSON.stringify(AppEnv, null, 2));
               console.error('Application ', Application, typeof Application, JSON.stringify(Application, null, 2));
