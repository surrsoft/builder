      ...
      const html = await new Promise((resolve, reject) => {
         global.requirejs(['Application/Env', 'UI/Base'], (AppEnv, UIBase) => {
            ...
            try {
               ...
               console.log("AppEnv ", AppEnv, typeof AppEnv, JSON.stringify(AppEnv, null, 2));
               console.log("Application ", Application, typeof Application, JSON.stringify(Application, null, 2));
               reject(e);
            }
         }, reject);
      });
