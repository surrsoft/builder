...
class TemplatesBuilder {
   ...
   async render(_options) {
      const html = await new Promise((resolve, reject) => {
         global.requirejs(['Application/Initializer', 'SbisEnv/PresentationService', 'UI/Base'], 
         (AppInit, PresentationService, UIBase) => {
            AppInit.default({}, new PresentationService.default(), new UIBase.StateReceiver());
