...
const
   ...
   { getCacheByModuleName } = require('./changes-store'),
   path = require('path');
...
/**
 *
 * @param{String} root - путь до корня приложения
 ...
 */
function readModuleAndGetParamsNames(
   root,
   libraryName,
   currentDependency,
   ...
   const
      moduleData = getCacheByModuleName(privateModulesCache, currentDependency),
