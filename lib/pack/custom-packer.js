...
async function _writeCustomPackage(packageConfig, applicationRoot) {
...
async function _generateCustomPackage(depsTree, applicationRoot, packageConfig, isSplittedCore) {
   ...
   await _writeCustomPackage(packageConfig, applicationRoot);
   return result;
}
   ...
   await pMap(
      ...
      async(config) => {
         ...
         try {
             ...
             */
            const currentResult = await _generateCustomPackage(
               depsTree,
               applicationRoot,
               config,
