   ...
   await pMap(
      ...
      async(currentBundle) => {
         ...
         currentModules.forEach((node) => {
             ...
             */
            /**
             * Костыли для нормальной работы стилей для SBIS3.CONTROLS и SBIS3.ENGINE для 411.
             * В 420 сделано постоянное решение
             * https://online.sbis.ru/opendoc.html?guid=8cda1f13-7287-475f-994f-4e1c20d3a11b
             */
            if (!node.startsWith('css!SBIS3.CONTROLS') && !node.startsWith('css!SBIS3.ENGINE')) {
