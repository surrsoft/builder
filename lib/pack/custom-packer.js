...
async function writeCustomPackage(packageConfig, applicationRoot, splittedCore, availableLanguage, defaultLanguage, isGulp) {
...
async function generateCustomPackage(
   ...
   await writeCustomPackage(packageConfig, applicationRoot, isSplittedCore, availableLanguage, defaultLanguage, isGulp);
   return result;
}
