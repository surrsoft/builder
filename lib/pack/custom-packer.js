               ...
               splittedCssByThemes[themeName]
                  .map(function onlyPath(module) {
                     ...
                     if (
                        ...
                        !cssIsPackageOutput &&
                        module.fullPath.startsWith(packageConfig.moduleOutput)
                     ) {
                        taskParameters.filesToRemove.push(module.fullPath);
                        logger.debug(`Удалили стиль ${module.fullPath} в рамках Интерфейсного модуля ${packageConfig.moduleName}`);
