...
const dblSlashes = /\\/g;
const packerDictionary = require('../../packer/tasks/lib/packDictionary');
...
function checkConfigPathForSplittedCore(pathToSource) {
...
module.exports = {
   ...
   checkConfigPathForSplittedCore: checkConfigPathForSplittedCore
};
