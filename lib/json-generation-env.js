...
const maxWorkerCount = Math.max(2, os.cpus().length - 1),
   debugMode = false; // для вывода тонны логов нужно включить
...
queue.onEmpty = function() {
   ...
   for (let className in jsonIndex.classes) {
