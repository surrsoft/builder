...
async function replaceIncludes(text, componentInfo, config, forPresentationService) {
   try {
      ...
      text = text.replace(START_DIALOG, componentInfo['webPage']['moduleName']);
   ...
   return new Promise(async(resolve, reject) => {
      ...
      try {
         ...
         resolve({
            ...
            text: await replaceIncludes(result, componentInfo, config, forPresentationService)
         });
      } catch (error) {
         reject(error);
      }
