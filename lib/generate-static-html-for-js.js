 ...
 * @param moduleInfo - interface module info for current html
 */
function checkForExternalInterfaceModule(moduleName, moduleInfo) {
   if (!(moduleName === moduleInfo.name || moduleInfo.depends.includes(moduleName))) {
...
function findFileInModules(relativePath, modules, moduleInfo) {
    ...
    */
   checkForExternalInterfaceModule(moduleName, moduleInfo);
