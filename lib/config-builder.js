...
module.exports = function (grunt, root, application) {
    ...
    cfg.i18n.main = {
        ...
        css: /\/lang\/..-..\/(..-..)\.css$/,
        country: /\/lang\/..\/(..)\.css$/,
        packages: root + application + 'resources/WI.SBIS/packer/i18n'
    };
    ...
    cfg.packwsmod.main = {
        ...
        application: application,
        src: '*.html',
        packages: root + application + 'resources/WI.SBIS/packer/modules'
    };
    ...
    cfg.packjs.main = {
        ...
        application: application,
        src: '*.html',
        packages: root + application + 'resources/WI.SBIS/packer/js'
    };
    ...
    cfg.packcss.main = {
        ...
        application: application,
        src: '*.html',
        packages: root + application + 'resources/WI.SBIS/packer/css'
    };
