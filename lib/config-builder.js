module.exports = function (grunt, app) {
   ...
   cfg['collect-dependencies'].main = {
      application: app || '.',
      modules: ['resources/**/*.module*.js', 'ws/**/*.module*.js'],
      src: ['**/*.js', '!**/*.test.js', '!**/design/**/*.js', '!**/node_modules/**/*.js']
   };
   ...
   cfg.uglify.main = {
      ...
      files: [{
         expand: true,
         cwd: app || '.',
         src: ['**/*.js', '**/*.hdl', '!**/*.min.js', '!**/*.routes.js', '!**/*.test.js', '!**/design/**/*.js', '!**/data-providers/*.js', '!**/node_modules/**/*.js'],
         dest: app || '.'
      }]
   };
   ...
   cfg.cssmin.main = {
      ...
      files: [{
         expand: true,
         cwd: app || '.',
         src: ['**/*.css', '!**/*.min.css', '!**/design/**/*.css', '!**/node_modules/**/*.css'],
         dest: app || '.'
      }]
   };
   ...
   cfg.xhtmlmin = {
      files: ['**/*.xhtml', '**/*.html', '!**/node_modules/**/*.html']
   };
   return cfg;
};