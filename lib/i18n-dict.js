...
(function () {
   ...
   module.exports = {
      createResultDict: function(g) {
         ...
         grunt.log.ok(grunt.template.today('hh:MM:ss') + ': Запускается построение реузультирующего словаря.');
         ...
         grunt.log.ok(grunt.template.today('hh:MM:ss') + ': Построение реузультирующего словаря выполнено.');
      }
   }
})();