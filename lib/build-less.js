...
async function processLessFile(data, filePath, theme, gulpModulesInfo, appRoot) {
...
async function buildLess(
   ...
   buildAllThemes.push(
      processLessFile(text, prettyFilePath, defaultModuleThemeObject, gulpModulesInfo, appRoot)
   );
