...
const typescript = require('saby-typescript/node_modules/typescript'),
   path = require('path'),
 ...
 */
const { compilerOptions } = fs.readJsonSync(path.join(process.cwd(), 'node_modules/saby-typescript/configs/es5.json'));
