...
module.exports = function(modules, jsonOutput) {
   return new Promise(function(resolve, reject) {
      generateJsDoc(modules, jsonOutput, async function(error) {
         ...
         try {
            return await readAllJSON(jsonOutput);
         } catch (err) {
            reject(err);
         }
