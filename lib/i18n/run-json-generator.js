...
/*
 * файл нужен для правильной загрузки run-json-generator.js в окружении тестов и в боевом окружении (т.е. в составе jinnee).
 * json-generator - общий для СТАНа и builder'а и расположен в папке 'jinnee/distrib/json-generator'.
...
if (fs.existsSync(libFromJinnee)) {
   ...
   logger.info('Загружаем sbis3-json-generator/run-json-generator.js из devDependencies');
