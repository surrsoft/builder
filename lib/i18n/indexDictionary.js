...
(function () {
   ...
   function getDictionaryPath(grunt, levelLocalDict, lang, _path, subDir) {
      ...
      var
         ...
         levelModules = levelLocalDict.levelModules,
    ...
    * lang/lang.ext
    * lang/lang.css
    * lang/COUNTRY/COUNTRY.css
    * в коневой директории
    */
            ...
            firstLevelDirs.forEach(function(fstLvlD) {
               ...
               for (var langKey in levelLocalDict) {
                  ...
                  if (levelLocalDict[langKey].levelDicts.length) {
                     ...
                     jsDict['/' + fstLvlD.replace(dblSlashes, '/') + '/'] = levelLocalDict[langKey].levelModules;
                  }
               }
            })
         }
